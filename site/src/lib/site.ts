...
/** Registered brand name for Mark's single collector guide (online chapters + PDF e-book). */
export const COLLECTORS_GUIDE = "The Tolkien Collector's Guide®" as const;
...
export const NAV: readonly NavItem[] = [
 ...
 { label: COLLECTORS_GUIDE, href: '/collectors-guide' },
