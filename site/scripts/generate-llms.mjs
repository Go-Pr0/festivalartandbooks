...
function staticSections() {
 return `## The Tolkien Collector's Guide® (hub + chapters)

${linkLine("The Tolkien Collector's Guide®", '/collectors-guide', "Mark Faith's complete free guide, readable online chapter by chapter or downloadable as a PDF e-book.")}
...
- [Collecting Tolkien books podcast](${EXTERNAL.podcast}): Recorded for Amazon around The Rings of Power release, Mark Faith on rare editions and the collector market.
